import { e as __extends$1, c as __spreadArray, l as __awaiter, B as __generator, W as getUA, n as isMobileCordova, o as isReactNative, X as isElectron, Y as isIE, Z as isUWP, R as isBrowserExtension, v as getModularInstance, E as createMockUserToken, H as LogLevel, L as Logger, F as Component, G as firebase$1 } from './index.esm-04dbab1f.js';
...
}(Error), N$1 = new Logger("@firebase/firestore");
 ...
 */ function A$1(t) {
    ...
    if (N$1.logLevel <= LogLevel.DEBUG) {
        var r = e.map(C);
        N$1.debug.apply(N$1, __spreadArray([ "Firestore (8.5.0): " + t ], r));
    }
}
...
function k$1(t) {
    ...
    if (N$1.logLevel <= LogLevel.ERROR) {
        var r = e.map(C);
        N$1.error.apply(N$1, __spreadArray([ "Firestore (8.5.0): " + t ], r));
    }
}
...
function x$1(t) {
    ...
    if (N$1.logLevel <= LogLevel.WARN) {
        var r = e.map(C);
        N$1.warn.apply(N$1, __spreadArray([ "Firestore (8.5.0): " + t ], r));
    }
}
...
/** Helper to compare arrays using isEqual(). */ function V$1(t, e, n) {
 ...
 */ var U$1 = /** @class */ function() {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new S$1(_.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new S$1(_.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new S$1(_.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new S$1(_.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
 ...
 */ var Q$1 = /** @class */ function() {
    function t(t, e, n) {
        void 0 === e ? e = 0 : e > t.length && R$1(), void 0 === n ? n = t.length - e : n > t.length - e && R$1(), 
    ...
    e.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var s = o[i];
            if (s.indexOf("//") >= 0) throw new S$1(_.INVALID_ARGUMENT, "Invalid segment (" + s + "). Paths must not contain // in them.");
...
}(Q$1), W$1 = /^[_a-zA-Z][_a-zA-Z0-9]*$/, H$1 = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return __extends$1(e, t), e.prototype.construct = function(t, n, r) {
    ...
    e.fromServerFormat = function(t) {
        for (var n = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new S$1(_.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            n.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new S$1(_.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new S$1(_.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new S$1(_.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new e(n);
    }, e.emptyPath = function() {
        return new e([]);
    }, e;
}(Q$1), Y$1 = /** @class */ function() {
    function t(t) {
        this.fields = t, 
    ...
    return t.prototype.covers = function(t) {
        ...
        return V$1(this.fields, t.fields, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}(), X$1 = /** @class */ function() {
 ...
 */ var ut = /** @class */ function() {
    ...
    return t.fromPath = function(e) {
        return new t(z$1.fromString(e));
    }, t.fromName = function(e) {
        return new t(z$1.fromString(e).popFirst(5));
    }, 
...
/** Extracts the backend's type order for the provided value. */ function at(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? et(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : R$1();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function ct(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            return Z$1(t.geoPointValue.latitude) === Z$1(e.geoPointValue.latitude) && Z$1(t.geoPointValue.longitude) === Z$1(e.geoPointValue.longitude);
        }(t, e);

      case 2 /* NumberValue */ :
        return function(t, e) {
            if ("integerValue" in t && "integerValue" in e) return Z$1(t.integerValue) === Z$1(e.integerValue);
            if ("doubleValue" in t && "doubleValue" in e) {
                var n = Z$1(t.doubleValue), r = Z$1(e.doubleValue);
      ...
      case 9 /* ArrayValue */ :
        return V$1(t.arrayValue.values || [], e.arrayValue.values || [], ct);
...
function ft(t, e) {
    ...
    switch (n) {
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            var n = Z$1(t.integerValue || t.doubleValue), r = Z$1(e.integerValue || e.doubleValue);
      ...
      case 7 /* RefValue */ :
        return function(t, e) {
            ...
            return F$1(n.length, r.length);
        }(t.referenceValue, e.referenceValue);

      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = F$1(Z$1(t.latitude), Z$1(e.latitude));
            return 0 !== n ? n : F$1(Z$1(t.longitude), Z$1(e.longitude));
...
function lt(t, e) {
    ...
    var n = J$1(t), r = J$1(e), i = F$1(n.seconds, r.seconds);
    return 0 !== i ? i : F$1(n.nanos, r.nanos);
}
 ...
 */ var It = /** @class */ function() {
    ...
    t.prototype.buildProto = function() {
        var t = this.applyOverlay(H$1.emptyPath(), this.overlayMap);
 ...
 */ function Tt(t) {
    var e = [];
    return K$1(t.fields || {}, (function(t, n) {
        var r = new H$1([ t ]);
        if (bt(n)) {
 ...
 */ function Jt(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new Ut(n)), e.p.push(new Ut(H$1.keyField(), "asc" /* ASCENDING */)); else {
            ...
            if (!i) {
                ...
                e.p.push(new Ut(H$1.keyField(), a));
            }
        }
    }
    return e.p;
...
function se(t, e, n) {
    var r = t.field.isKeyField() ? ut.comparator(e.key, n.key) : function(t, e, n) {
        ...
        return null !== r && null !== i ? ft(r, i) : R$1();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
...
function be(t) {
    return Z$1(t.integerValue || t.doubleValue);
}
...
function xe(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.precondition.isEqual(e.precondition) && !!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && V$1(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof ye && e instanceof ye || t instanceof me && e instanceof me ? V$1(t.elements, e.elements, ct) : t instanceof we && e instanceof we ? ct(t.A, e.A) : t instanceof pe && e instanceof pe;
 ...
 */ function Ke(t) {
    ...
    return k$1("GRPC error has no .code"), _.UNKNOWN;
    switch (t) {
      case Fe.OK:
        return _.OK;
...
var Ge = /** @class */ function() {
    ...
    t.prototype.check = function() {
        if (this.isRed() && this.left.isRed()) throw R$1();
        if (this.right.isRed()) throw R$1();
        var t = this.left.check();
        if (t !== this.right.check()) throw R$1();
 ...
 */ var sn = /** @class */ function() {
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(X$1.EMPTY_BYTE_STRING, n, nn(), nn(), nn());
    }, t;
}(), an = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = X$1.EMPTY_BYTE_STRING), void 0 === r && (r = null), this.state = t, 
    ...
    t.prototype.ut = function(t) {
        ...
        return this.H = Xe(), this.J = dn(), this.Y = new We(F$1), i;
    }, 
    /**
    ...
    t.prototype.U = function(t) {
        ...
        var e = this.J.get(t);
        return e || (e = new We(F$1), this.J = this.J.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.st = function(t) {
        ...
        return e || A$1("WatchChangeAggregator", "Detected inactive target", t), e;
    }, 
    /**
...
function In(t) {
    return O$1(!!t), B.fromTimestamp(function(t) {
        var e = J$1(t);
        return new U$1(e.seconds, e.nanos);
    }(t));
}
...
function Sn(t, e) {
    var n = En(e);
    if (n.get(1) !== t.databaseId.projectId) throw new S$1(_.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
    if (n.get(3) !== t.databaseId.database) throw new S$1(_.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
    return new ut(kn(n));
}
...
function On(t, e) {
    var n = e.currentDocument ? function(t) {
        ...
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) O$1("REQUEST_TIME" === e.setToServerValue), n = new pe; else if ("appendMissingElements" in e) {
                var r = e.appendMissingElements.values || [];
                n = new ye(r);
            } else if ("removeAllFromArray" in e) {
                var i = e.removeAllFromArray.values || [];
                n = new me(i);
            } else "increment" in e ? n = new we(t, e.increment) : R$1();
            var o = H$1.fromServerFormat(e.fieldPath);
            return new Te(o, n);
        }(t, e);
    })) : [];
    if (e.update) {
        ...
        if (e.updateMask) {
            var s = function(t) {
                var e = t.fieldPaths || [];
                return new Y$1(e.map((function(t) {
                    return H$1.fromServerFormat(t);
                })));
            }(e.updateMask);
 ...
 */ function $n(t) {
    ...
    // source value.
        ...
        var s = t.indexOf("", o);
        switch ((s < 0 || s > n) && R$1(), t.charAt(s + 1)) {
          case "":
...
var pr = __spreadArray(__spreadArray([], __spreadArray(__spreadArray([], __spreadArray(__spreadArray([], __spreadArray(__spreadArray([], [ tr.store, er.store, nr.store, or.store, ur.store, Zn.store, cr.store, ar.store ]), [ fr.store ])), [ sr.store ])), [ hr.store ])), [ lr.store, dr.store ]), yr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", vr = /** @class */ function() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.callbackAttached && R$1(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(n, this.error) : this.wrapSuccess(e, this.result) : new t((function(t, i) {
    ...
    return t.open = function(e, n, r, i) {
        ...
        t && this.ft.reject(t), this.aborted || (A$1("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    function e(n, r, i) {
        ...
        // log on 12.2.
        12.2 === e._t(getUA()) && k$1("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    return e.delete = function(t) {
        return A$1("SimpleDb", "Removing database:", t), Sr(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
    ...
    e.prototype.At = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return this.db ? [ 3 /*break*/ , 2 ] : (A$1("SimpleDb", "Opening database:", this.name), 
                    e = this, [ 4 /*yield*/ , new Promise((function(e, r) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            "VersionError" === n.name ? r(new S$1(_.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r(new Tr(t, n));
                        }, i.onupgradeneeded = function(t) {
                            A$1("SimpleDb", 'Database "' + n.name + '" requires upgrade from version:', t.oldVersion);
                            var e = t.target.result;
                            n.wt.Rt(e, i.transaction, t.oldVersion, n.version).next((function() {
                                A$1("SimpleDb", "Database upgrade to version " + n.version + " complete");
                            }));
                        };
                    })) ]);
                    ...
                    i = "readonly" === e, o = 0, s = function() {
                        ...
                        return __generator(this, (function(f) {
                            switch (f.label) {
                              ...
                              case 4:
                                return c = f.sent(), h = "FirebaseError" !== c.name && o < 3, A$1("SimpleDb", "Transaction failed with error:", c.message, "Retrying:", h), 
 ...
 */ var _r = /** @class */ function() {
    ...
    return t.prototype.put = function(t, e) {
        var n;
        return void 0 !== e ? (A$1("SimpleDb", "PUT", this.store.name, t, e), n = this.store.put(e, t)) : (A$1("SimpleDb", "PUT", this.store.name, "<auto-key>", t), 
    ...
    t.prototype.add = function(t) {
        return A$1("SimpleDb", "ADD", this.store.name, t, t), Sr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
            ...
            return void 0 === n && (n = null), A$1("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return A$1("SimpleDb", "DELETE", this.store.name, t), Sr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return A$1("SimpleDb", "COUNT", this.store.name), Sr(this.store.count());
...
function Dr(e) {
    ...
    if (n >= 12.2 && n < 13) {
        ...
        if (e.message.indexOf(r) >= 0) {
            ...
            var i = new S$1("internal", "IOS_INDEXEDDB_BUG1: IndexedDb has thrown '" + r + "'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
            return Nr || (Nr = !0, 
 ...
 */ var xr = /** @class */ function() {
    ...
    t.prototype.applyToLocalDocumentSet = function(t) {
        ...
        return this.batchId === t.batchId && V$1(this.mutations, t.mutations, (function(t, e) {
            return xe(t, e);
        })) && V$1(this.baseMutations, t.baseMutations, (function(t, e) {
            return xe(t, e);
        }));
    }, t;
}(), Cr = /** @class */ function() {
    ...
    return t.from = function(e, n, r) {
        O$1(e.mutations.length === r.length);
     ...
     * time from which the server should resume sending results.
     */ , s) {
        void 0 === i && (i = B.min()), void 0 === o && (o = B.min()), void 0 === s && (s = X$1.EMPTY_BYTE_STRING), 
...
function qr(t) {
    var e = new U$1(t.seconds, t.nanoseconds);
    return B.fromTimestamp(e);
}
...
/** Decodes a DbMutationBatch into a MutationBatch */ function Ur(t, e) {
    ...
    var s = e.mutations.map((function(e) {
        return On(t.Lt, e);
    })), u = U$1.fromMillis(e.localWriteTimeMs);
...
/** Decodes a DbTarget into TargetData */ function Br(t) {
    ...
    return void 0 !== t.query.documents ? (O$1(1 === (n = t.query).documents.length), 
    e = Zt(zt(Dn(n.documents[0])))) : e = function(t) {
        return Zt(Mn(t));
    }(t.query), new Rr(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, X$1.fromBase64String(t.resumeToken))
 ...
 */ var Wr = /** @class */ function() {
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new We(z$1.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new We(z$1.comparator)).toArray();
    }, t;
}(), Yr = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        var n = [], r = IDBKeyRange.bound([ e, "" ], [ q$1(e), "" ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
...
var ei = /** @class */ function() {
    ...
    return t.Kt = function(e, n, r, i) {
        ...
        return O$1("" !== e.uid), new t(e.isAuthenticated() ? e.uid : "", n, r, i);
        ...
        return s.add({}).next((function(u) {
            ...
            for (var a = new xr(u, e, n, r), c = function(t, e, n) {
                ...
                return F$1(t.canonicalString(), e.canonicalString());
        ...
        return ri(t).get(e).next((function(t) {
            return t ? (O$1(t.userId === n.userId), Ur(n.R, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.jt = function(t, e) {
        ...
        return ri(t).Ot({
            ...
            e.userId === n.userId && (O$1(e.batchId >= r), o = Ur(n.R, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        // the given documentKey.
            ...
            return ri(t).get(c).next((function(t) {
                if (!t) throw R$1();
                O$1(t.userId === n.userId), o.push(Ur(n.R, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = e.path, i = r.length + 1, o = nr.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new We(F$1);
        return ii(t).Ot({
            range: s
        }, (function(t, e, o) {
        ...
        return e.forEach((function(e) {
            i.push(ri(t).get(e).next((function(t) {
                if (null === t) throw R$1();
                O$1(t.userId === n.userId), r.push(Ur(n.R, t));
            })));
        })), gr.waitFor(i).next((function() {
            return r;
        }));
 ...
 */ var si = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Xt(t).next((function(t) {
            return B.fromTimestamp(new U$1(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((function() {
            ...
            return O$1(e.targetCount > 0), e.targetCount -= 1, n.Zt(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.ee = function(t, e) {
        ...
        var n = Hn(e.path), r = IDBKeyRange.bound([ n ], [ q$1(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return hi(t).Ot({
 ...
 */ function fi(t) {
    return __awaiter(this, void 0, void 0, (function() {
        return __generator(this, (function(e) {
            ...
            return A$1("LocalStore", "Unexpectedly lost primary lease"), [ 2 /*return*/ ];
        }));
    }));
}
 ...
 * limitations under the License.
 */ function li(t, e) {
    var n = t[0], r = t[1], i = e[0], o = e[1], s = F$1(n, i);
    return 0 === s ? F$1(r, o) : s;
}
 ...
 */ var di = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        ...
        A$1("LruGarbageCollector", "Garbage collection scheduled in " + n + "ms"), this.ce = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , n, (function() {
            return __awaiter(e, void 0, void 0, (function() {
                ...
                return __generator(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Er(e = n.sent()) ? (A$1("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        var n = this;
        if (0 === e) return gr.resolve(E$1.o);
        var r = new di(e);
        ...
        var n = this;
        return -1 === this.params.cacheSizeCollectionThreshold ? (A$1("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        gr.resolve($r)) : this.getCacheSize(t).next((function(r) {
            return r < n.params.cacheSizeCollectionThreshold ? (A$1("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.params.cacheSizeCollectionThreshold), 
            $r) : n.fe(t, e);
        }));
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return e > c.params.maximumSequenceNumbersToCollect ? (A$1("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + c.params.maximumSequenceNumbersToCollect + " from " + e), 
            ...
            return a = Date.now(), D$1() <= LogLevel.DEBUG && A$1("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - f) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (u - s) + "ms\n\tRemoved " + t + " documents in " + (a - u) + "ms\nTotal Duration: " + (a - f) + "ms"), 
            gr.resolve({
                didRun: !0,
...
var Di = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Ai = /** @class */ function() {
    ...
    h) {
        ...
        }, !t.yt()) throw new S$1(_.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new S$1(_.FAILED_PRECONDITION, Di);
    ...
    t.prototype.je = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            ...
            return A$1("IndexedDbPersistence", "Failed to extend owner lease: ", e), t.isPrimary;
            if (!t.allowTabSynchronization) throw e;
            return A$1("IndexedDbPersistence", "Releasing owner lease after error during lease refresh", e), 
            /* isPrimary= */ !1;
        })).then((function(e) {
    ...
    t.prototype.Ye = function(t) {
        ...
        return this.Ce ? gr.resolve(!0) : ki(t).get(Zn.key).next((function(n) {
            ...
            return e.isPrimary !== t && A$1("IndexedDbPersistence", "Client " + (t ? "is" : "is not") + " eligible for a primary lease."), 
            t;
        }));
    ...
    t.prototype.fn = function() {
        ...
        return this.Be.runTransaction(t, o, pr, (function(o) {
            return i = new Ar(o, r.Ne ? r.Ne.next() : E$1.o), "readwrite-primary" === e ? r.Je(i).next((function(t) {
                return !!t || r.Ye(i);
            })).next((function(e) {
                if (!e) throw k$1("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Se.enqueueRetryable((function() {
                    return r.Me(!1);
                })), new S$1(_.FAILED_PRECONDITION, yr);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.dn = function(t) {
        var e = this;
        return ki(t).get(Zn.key).next((function(t) {
            if (null !== t && e.sn(t.leaseTimestampMs, 5e3) && !e.cn(t.ownerId) && !e.tn(t) && !(e.Ce || e.allowTabSynchronization && t.allowTabSynchronization)) throw new S$1(_.FAILED_PRECONDITION, Di);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.Xe = function(t) {
        ...
        return n.get(Zn.key).next((function(t) {
            return e.tn(t) ? (A$1("IndexedDbPersistence", "Releasing primary lease."), n.delete(Zn.key)) : gr.resolve();
        }));
    }, 
 ...
 */
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (Wt(e) || Ht(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (D$1() <= LogLevel.DEBUG && A$1("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), re(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return D$1() <= LogLevel.DEBUG && A$1("QueryEngine", "Using full collection scan to execute query:", re(e)), 
        ...
        return function(t, e, n, r) {
            ...
            return o.forEach((function(t) {
                s = s.next((function() {
                    ...
                    O$1(null !== o), e.version.compareTo(o) < 0 && (i.applyToRemoteDocument(e, n), e.isValidDocument() && 
 ...
 */ function Bi(t, e) {
     ...
     */
                    function(t, e, n) {
                        ...
                        return O$1(e.resumeToken.approximateByteSize() > 0), 0 === t.resumeToken.approximateByteSize() || (
...
i) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, s) {
            ...
            o = o.insert(n, s)) : A$1("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", u.version, " Watch version:", s.version);
        })), o;
    }))
    /**
            ...
            switch (u.label) {
              ...
              case 4:
                ...
                // don't define exact LRU semantics so this is acceptable.
                                return A$1("LocalStore", "Failed to update sequence numbers for target " + e + ": " + s), 
                [ 3 /*break*/ , 5 ];
 ...
 */ function Xi(t, e, n, r) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(p) {
            switch (p.label) {
              case 0:
                for (i = L$1(t), o = nn(), s = Xe(), u = tn(), a = 0, c = n; a < c.length; a++) h = c[a], 
                ...
                return l = i.$n.newChangeBuffer({
                    ...
                    return Zt(zt(z$1.fromString("__bundle__/docs/" + t)));
                }(r)) ];
 ...
 */ function $i(t, e, n) {
    return void 0 === n && (n = nn()), __awaiter(this, void 0, void 0, (function() {
        var r, i;
        return __generator(this, (function(o) {
            switch (o.label) {
              case 0:
              ...
              case 1:
                return r = o.sent(), [ 2 /*return*/ , (i = L$1(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    var o = In(e.readTime);
                    // Simply save the query itself if it is older than what the SDK already
                    // has.
                                        if (r.snapshotVersion.compareTo(o) >= 0) return i.Qe.saveNamedQuery(t, e);
                    // Update existing target data because the query from the bundle is newer.
                                        var s = r.withResumeToken(X$1.EMPTY_BYTE_STRING, o);
 ...
 */ var Ji = /** @class */ function() {
    ...
    t.prototype.Zn = function(t) {
        var e = this, n = new ut(new z$1([])), r = new to(n, t), i = new to(n, t + 1), o = [];
        ...
        var e = new ut(new z$1([])), n = new to(e, t), r = new to(e, t + 1), i = nn();
    ...
    return t.prototype.checkEmpty = function(t) {
        ...
        var o = new to(new ut(i), 0), s = new We(F$1);
    ...
    function t(t, e) {
        var n = this;
        this.gs = {}, this.Ne = new E$1(0), this.xe = !1, this.xe = !0, this.referenceDelegate = t(this), 
...
var lo = /** @class */ function() {
    ...
    return t.Vs = function(e, n, r) {
        ...
        return s && o.error && ((s = "string" == typeof o.error.message && "string" == typeof o.error.code) && (i = new S$1(o.error.code, o.error.message))), 
        s ? new t(e, n, o.state, i) : (k$1("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), 
        null);
    ...
    return t.Vs = function(e, n) {
        ...
        return o && i.error && ((o = "string" == typeof i.error.message && "string" == typeof i.error.code) && (r = new S$1(i.error.code, i.error.message))), 
        o ? new t(e, i.state, r) : (k$1("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n), 
        null);
    }, t.prototype.Ss = function() {
        var t = {
            state: this.state,
    ...
    function t(t, e, n, r, i) {
        ...
        this.ks = new Ge(F$1), this.started = !1, 
        /**
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.yt = function(t) {
        ...
        return A$1("SharedClientState", "READ", t, e), e;
    }, t.prototype.setItem = function(t, e) {
        A$1("SharedClientState", "SET", t, e), this.storage.setItem(t, e);
    }, t.prototype.removeItem = function(t) {
        A$1("SharedClientState", "REMOVE", t), this.storage.removeItem(t);
    }, t.prototype.Fs = function(t) {
        var e = this, n = t;
        // Note: The function is typed to take Event to be interface-compatible with
        // `Window.addEventListener`.
                if (n.storageArea === this.storage) {
            if (A$1("SharedClientState", "EVENT", n.key, n.newValue), n.key === this.$s) return void k$1("Received WebStorage notification for local change. Another client might have garbage-collected our state");
                    ...
                    return __generator(this, (function(u) {
                        if (this.started) {
                            if (null !== n.key) if (this.Ls.test(n.key)) {
                                ...
                                return e;
                            }(n.newValue)) !== E$1.o && this.sequenceNumberHandler(s); else if (n.key === this.Qs) return [ 2 /*return*/ , this.syncEngine.ci() ];
                        } else this.Os.push(n);
                        return [ 2 /*return*/ ];
                    }));
                }));
    ...
    t.prototype.js = function(t) {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine.ui(t.batchId, t.state, t.error) ] : (A$1("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    ...
    return __extends$1(u, t), u.prototype.ki = function(t, e, n, r) {
                ...
                try {
                    switch (s.getLastErrorCode()) {
                      case ErrorCode.NO_ERROR:
                        ...
                        A$1("Connection", "XHR received:", JSON.stringify(e)), i(e);
                        break;

                      case ErrorCode.TIMEOUT:
                        A$1("Connection", 'RPC "' + t + '" timed out'), o(new S$1(_.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case ErrorCode.HTTP_ERROR:
                        var n = s.getStatus();
                        if (A$1("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", s.getResponseText()), 
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new S$1(u, r.message));
                            } else o(new S$1(_.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new S$1(_.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var l = a.join("");
        A$1("Connection", "Creating WebChannel: " + l, f);
        var d = c.createWebChannel(l, f), w = !1, b = !1, I = new Eo({
            Ei: function(t) {
                b ? A$1("Connection", "Not sending because WebChannel is closed:", t) : (w || (A$1("Connection", "Opening WebChannel transport."), 
                d.open(), w = !0), A$1("Connection", "WebChannel sending:", t), d.send(t));
            },
            Ti: function() {
                return d.close();
            }
        ...
        return T(d, WebChannel.EventType.OPEN, (function() {
            b || A$1("Connection", "WebChannel transport opened.");
        })), T(d, WebChannel.EventType.CLOSE, (function() {
            b || (b = !0, A$1("Connection", "WebChannel transport closed"), I.Vi());
        })), T(d, WebChannel.EventType.ERROR, (function(t) {
            b || (b = !0, x$1("Connection", "WebChannel transport errored:", t), I.Vi(new S$1(_.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!b) {
                ...
                if (i) {
                    A$1("Connection", "WebChannel received error:", i);
 ...
 */
                    ...
                    b = !0, I.Vi(new S$1(s, u)), d.close();
                } else A$1("Connection", "WebChannel received:", n), I.Si(n);
            }
        })), T(h, Event.STAT_EVENT, (function(t) {
            t.stat === Stat.PROXY ? A$1("Connection", "Detected buffering proxy") : t.stat === Stat.NOPROXY && A$1("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
    ...
    return t.prototype.Ni = function(t, e, n, r) {
        var i = this.xi(t, e);
        A$1("RestConnection", "Sending: ", i, n);
        var o = {};
        return this.Fi(o, r), this.ki(t, i, o, n).then((function(t) {
            return A$1("RestConnection", "Received: ", t), t;
        }), (function(e) {
 ...
 */ var Ao = /** @class */ function() {
    ...
    t.prototype.ji = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && A$1("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.qi + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    t.prototype.ar = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new S$1(_.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.dr(e);
            }));
        }));
    ...
    t.prototype.dr = function(t) {
        ...
        return A$1("PersistentStream", "close with error: " + t), this.stream = null, this.close(3 /* Error */ , t);
    }, 
    /**
    ...
    t.prototype.hr = function(t) {
        ...
        return function(n) {
            e.Se.enqueueAndForget((function() {
                return e.Yi === t ? n() : (A$1("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return __extends$1(e, t), e.prototype.wr = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                // if unset
                var r = function(t) {
                    return "NO_CHANGE" === t ? 0 /* NoChange */ : "ADD" === t ? 1 /* Added */ : "REMOVE" === t ? 2 /* Removed */ : "CURRENT" === t ? 3 /* Current */ : "RESET" === t ? 4 /* Reset */ : R$1();
    ...
    e.prototype.start = function() {
        ...
        O$1(!!t.streamToken), this.lastStreamToken = t.streamToken, this.gr) {
            // A successful first write response means the stream is healthy,
            // Note, that we could consider a successful handshake healthy, however,
            // the write itself might be causing an error we want to back off from.
            this.Zi.reset();
            var e = function(t, e) {
                return t && t.length > 0 ? (O$1(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
        ...
        // The first response is always the handshake response
                return O$1(!t.writeResults || 0 === t.writeResults.length), this.gr = !0, 
        this.listener.Ir();
    }, 
    /**
    ...
    return __extends$1(e, t), e.prototype.br = function() {
        if (this.Rr) throw new S$1(_.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ e.prototype.Ni = function(t, e, n) {
        ...
        return this.br(), this.credentials.getToken().then((function(i) {
            ...
            t) : new S$1(_.UNKNOWN, t.toString());
        }));
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.Vr ? (k$1(e), this.Vr = !1) : A$1("OnlineStateTracker", e);
        ...
        n.enqueueAndForget((function() {
            return __awaiter(o, void 0, void 0, (function() {
                return __generator(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return Ko(this) ? (A$1("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return __awaiter(this, void 0, void 0, (function() {
                                var e;
                                return __generator(this, (function(n) {
    ...
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(s) {
            switch (s.label) {
              ...
              case 3:
                return r = s.sent(), A$1("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), r), 
                [ 4 /*yield*/ , Ho(t, r) ];
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            // state.
                            t.Or.set(e, n.withResumeToken(X$1.EMPTY_BYTE_STRING, n.snapshotVersion)), 
              ...
              case 11:
                return A$1("RemoteStore", "Failed to raise snapshot:", o = s.sent()), [ 4 /*yield*/ , Ho(t, o) ];
                ...
                t.asyncQueue.enqueueRetryable((function() {
                    return __awaiter(r, void 0, void 0, (function() {
                        return __generator(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return A$1("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , n() ];
        ...
        return __awaiter(e, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 3:
                    e.sent(), t.kr.length > 0 && (A$1("RemoteStore", "Stopping write stream with " + t.kr.length + " pending writes"), 
                    t.kr = []), e.label = 4;
...
var ss = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new S$1(_.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
 ...
 */ function us(t, e) {
    if (k$1("AsyncQueue", e + ": " + t), Er(t)) return new S$1(_.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var as = /** @class */ function() {
    ...
    return t.prototype.track = function(t) {
        ...
        // Metadata->Added
        // Removed->Metadata
        R$1() : this.Kr = this.Kr.insert(e, t);
            ...
            switch (u.label) {
              ...
              case 1:
                return u.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = L$1(t), i = U$1.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), nn());
              ...
              case 2:
                return i = u.sent(), r.sharedClientState.addPendingMutation(i.batchId), function(t, e, n) {
                    ...
                    r || (r = new Ge(F$1)), r = r.insert(e, n), t.xo[t.currentUser.toKey()] = r;
            ...
            switch (i.label) {
              ...
              case 2:
                ...
                e.targetChanges.forEach((function(t, e) {
                    ...
                    t.addedDocuments.size > 0 ? r.bo = !0 : t.modifiedDocuments.size > 0 ? O$1(r.bo) : t.removedDocuments.size > 0 && (O$1(r.bo), 
                    r.bo = !1));
                })), [ 4 /*yield*/ , zs(n, r, e) ];
        ...
        return __generator(this, (function(c) {
            switch (c.label) {
              case 0:
                ...
                /* targetMismatches= */ new We(F$1), s, u), [ 4 /*yield*/ , Os(r, a) ]) : [ 3 /*break*/ , 2 ];
                ...
                return o.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n._n.lookupMutationBatch(t, e).next((function(e) {
                            return O$1(null !== e), r = e.keys(), n._n.removeMutationBatch(t, e);
                        })).next((function() {
                            return n._n.performConsistencyCheck(t);
                        })).next((function() {
                            return n.Mn.pn(t, r);
 ...
 */ function Vs(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(u) {
            switch (u.label) {
              case 0:
                Ko((n = L$1(t)).remoteStore) || A$1("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                u.label = 1;
...
function Ks(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Es ? (t.No.addReference(o.key, e), Gs(t, o)) : o instanceof _s ? (A$1("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function Gs(t, e) {
    ...
    t.Do.get(n) || t.So.has(r) || (A$1("SyncEngine", "New document in limbo: " + n), t.So.add(r), 
    Qs(t));
}
 ...
 */ function Qs(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        var n = new ut(z$1.fromString(e)), r = t.ko.next();
        t.Co.set(r, new Ds(n)), t.Do = t.Do.insert(n, r), Fo(t.remoteStore, new Rr(Zt(zt(n.path)), r, 2 /* LimboResolution */ , E$1.o));
    }
}
                            ...
                            switch (f.label) {
                              ...
                              case 3:
                                ...
                                // would have, but it should not invalidate the integrity of the data.
                                                                return A$1("LocalStore", "Failed to update sequence numbers: " + r), 
                                [ 3 /*break*/ , 4 ];
...
function Ws(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(i) {
            switch (i.label) {
              case 0:
                return (n = L$1(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (A$1("SyncEngine", "User change. New user:", e.toKey()), 
              ...
              case 1:
                ...
                function(t, e) {
                    t.Fo.forEach((function(t) {
                        t.forEach((function(t) {
                            t.reject(new S$1(_.CANCELLED, "'waitForPendingWrites' promise is rejected due to a user change."));
                        }));
                    })), t.Fo.clear();
                }(n), 
        ...
        return __generator(this, (function(s) {
            switch (s.label) {
              ...
              case 6:
                ...
                // as applicable.
                A$1("SyncEngine", "Cannot apply mutation batch with id: " + e), s.label = 7;
        ...
        return __generator(this, (function(u) {
            switch (u.label) {
              case 0:
                ...
                A$1("SyncEngine", "Ignoring unexpected query state notification."), [ 3 /*break*/ , 8 ]) : [ 3 /*break*/ , 1 ];
        ...
        return __generator(this, (function(d) {
            switch (d.label) {
              ...
              case 1:
                ...
                A$1("SyncEngine", "Adding an already active target " + s), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , Wi(r.localStore, s) ]) : [ 3 /*break*/ , 6 ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(c) {
                switch (c.label) {
                  ...
                  case 14:
                    return x$1("SyncEngine", "Loading bundle failed with " + (a = c.sent())), n._failWith(a), 
                    [ 3 /*break*/ , 15 ];
...
var uu = /** @class */ function() {
    ...
    return __extends$1(e, t), e.prototype.initialize = function(e) {
        ...
        var e = So();
        if (!go.yt(e)) throw new S$1(_.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        ...
        return function(t) {
            return __awaiter(this, void 0, void 0, (function() {
                ...
                return __generator(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = L$1(t), A$1("RemoteStore", "RemoteStore shutting down."), e.$r.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , Mo(e) ];
 ...
 */ var lu = /** @class */ function() {
    ...
    return t.prototype.lookup = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(r) {
                switch (r.label) {
                  case 0:
                    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new S$1(_.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, e) {
                        return __awaiter(this, void 0, void 0, (function() {
                            var n, r, i, o, s, u;
                            return __generator(this, (function(a) {
        ...
        if (n) {
            ...
            throw new S$1(_.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.preconditionForUpdate = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new S$1(_.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    e, n) {
        ...
        this.clientId = M$1.u(), this.credentialListener = function() {}, this.receivedInitialUser = new mr, 
        this.credentials.setChangeListener((function(t) {
            A$1("FirestoreClient", "Received user=", t.uid), r.user = t, r.credentialListener(t), 
    ...
    t.prototype.verifyNotTerminated = function() {
        if (this.asyncQueue.isShuttingDown) throw new S$1(_.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.terminate = function() {
        var t = this;
 ...
 */ function mu(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(o) {
            switch (o.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), A$1("FirestoreClient", "Initializing OfflineComponentProvider"), 
    ...
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(i) {
            switch (i.label) {
              ...
              case 1:
                return n = i.sent(), A$1("FirestoreClient", "Initializing OnlineComponentProvider"), 
                [ 4 /*yield*/ , t.getConfiguration() ];
                        ...
                        return function(t, e) {
                            return __awaiter(this, void 0, void 0, (function() {
                                ...
                                return __generator(this, (function(i) {
                                    switch (i.label) {
                                      case 0:
                                        return (n = L$1(t)).asyncQueue.verifyOperationInProgress(), A$1("RemoteStore", "RemoteStore received new credentials"), 
                                        r = Ko(n), 
...
function wu(t) {
    return __awaiter(this, void 0, void 0, (function() {
        return __generator(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.offlineComponents ? [ 3 /*break*/ , 2 ] : (A$1("FirestoreClient", "Using default OfflineComponentProvider"), 
                [ 4 /*yield*/ , mu(t, new uu) ]);
...
function bu(t) {
    return __awaiter(this, void 0, void 0, (function() {
        return __generator(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.onlineComponents ? [ 3 /*break*/ , 2 ] : (A$1("FirestoreClient", "Using default OnlineComponentProvider"), 
                [ 4 /*yield*/ , gu(t, new hu) ]);
                    ...
                    return r = function(t, e, n, r, i) {
                        var o = new lu({
                            next: function(o) {
                                ...
                                i.reject(new S$1(_.UNAVAILABLE, "Failed to get document because the client is offline.")) : u && o.fromCache && r && "server" === r.source ? i.reject(new S$1(_.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(o);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
                    ...
                    return r = function(t, e, n, r, i) {
                        var o = new lu({
                            next: function(n) {
                                ...
                                e.enqueueAndForget((function() {
                                    return ps(t, s);
                                })), n.fromCache && "server" === r.source ? i.reject(new S$1(_.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
...
function(t, e, n, r, i, o, s) {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.cc !== e ? (A$1("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (O$1("string" == typeof n.accessToken), new Cu(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.uc = function() {
        ...
        return O$1(null === t || "string" == typeof t), new ao(t);
    }, t;
}(), Pu = /** @class */ function() {
    function t(t, e, n) {
 ...
 */
function Fu(t, e, n) {
    if (!n) throw new S$1(_.INVALID_ARGUMENT, "Function " + t + "() cannot be called with an empty " + e + ".");
}
...
function Vu(t, e) {
    ...
    if (void 0 !== e.mergeFields && void 0 !== e.merge) throw new S$1(_.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
 ...
 */ function qu(t, e, n, r) {
    if (!0 === e && !0 === r) throw new S$1(_.INVALID_ARGUMENT, t + " and " + n + " cannot be used together.");
}
 ...
 */ function Uu(t) {
    if (!ut.isDocumentKey(t)) throw new S$1(_.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function Bu(t) {
    if (ut.isDocumentKey(t)) throw new S$1(_.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
...
/** Returns a string describing the type / value of the provided input. */ function ju(t) {
    ...
    return "function" == typeof t ? "a function" : R$1();
}
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new S$1(_.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = ju(t);
        throw new S$1(_.INVALID_ARGUMENT, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function Gu(t, e) {
    if (e <= 0) throw new S$1(_.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */ var Qu = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new S$1(_.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new S$1(_.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    ...
    function t(t, e) {
        ...
        this._databaseId = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new S$1(_.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
    ...
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this._app) throw new S$1(_.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this._app;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this._settingsFrozen) throw new S$1(_.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this._settings = new Qu(t), void 0 !== t.credentials && (this._credentials = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new S$1(_.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */
        return t = this, (e = xu.get(t)) && (A$1("ComponentProvider", "Removing Datastore"), 
 ...
 */ function Xu(t, e) {
    ...
    if (t = getModularInstance(t), Fu("collection", "path", e), t instanceof zu) return Bu(n = z$1.fromString.apply(z$1, __spreadArray([ e ], r))), 
    new Yu(t, /* converter= */ null, n);
    if (!(t instanceof Wu || t instanceof Yu)) throw new S$1(_.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Bu(n = z$1.fromString.apply(z$1, __spreadArray([ t.path ], r)).child(z$1.fromString(e))), new Yu(t.firestore, 
    /* converter= */ null, n);
}
 ...
 */ function $u(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = M$1.u()), Fu("doc", "path", e), t instanceof zu) return Uu(n = z$1.fromString.apply(z$1, __spreadArray([ e ], r))), 
    new Wu(t, 
    /* converter= */ null, new ut(n));
    if (!(t instanceof Wu || t instanceof Yu)) throw new S$1(_.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Uu(n = t._path.child(z$1.fromString.apply(z$1, __spreadArray([ e ], r)))), new Wu(t.firestore, t instanceof Yu ? t.converter : null, new ut(n));
}
...
var ta$1 = /** @class */ function() {
    function t() {
        ...
        this.Ec = function() {
            var e = No();
            e && A$1("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.Zi.Gi();
        };
        var e = No();
    ...
    t.prototype.Ac = function() {
                ...
                switch (n.label) {
                  ...
                  case 3:
                    ...
                    // Failure will be handled by AsyncQueue
                                        return A$1("AsyncQueue", "Operation failed with retryable error: " + t), 
                    [ 3 /*break*/ , 4 ];
        ...
        var e = this, n = this.fc.then((function() {
            return e.yc = !0, t().catch((function(t) {
                ...
                throw e.mc = t, e.yc = !1, k$1("INTERNAL UNHANDLED ERROR: ", 
                /**
...
var na$1 = /** @class */ function() {
...
}(), ra$1 = -1, ia = /** @class */ function(t) {
    /** @hideconstructor */
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, n) || this).type = "firestore", r._queue = new ta$1, r._persistenceKey = "name" in e ? e.name : "[DEFAULT]", 
        r;
    }
    return __extends$1(e, t), e.prototype._terminate = function() {
        ...
        sa$1(this), this._firestoreClient.terminate();
    }, e;
}(zu);
 ...
 */
function oa$1(t) {
    return t._firestoreClient || sa$1(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}
 ...
 */
function aa$1(t) {
    if (t._initialized || t._terminated) throw new S$1(_.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ var ca$1 = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new S$1(_.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
     ...
     */    return t.fromBase64String = function(e) {
        try {
            return new t(X$1.fromBase64String(e));
        } catch (e) {
            throw new S$1(_.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
     ...
     */
    t.fromUint8Array = function(e) {
        return new t(X$1.fromUint8Array(e));
    }, 
    /**
...
function(t) {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new S$1(_.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new S$1(_.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
...
}(), da$1 = /^__.*__$/, pa$1 = /** @class */ function() {
    function t(t, e, n) {
...
/** A "context" object passed around while parsing user data. */ var ma$1 = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Cc = function(e) {
        ...
        return Fa$1(t, this.settings.methodName, this.settings.Mc || !1, this.path, this.settings.Lc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (va$1(this.Dc) && da$1.test(t)) throw this.$c('Document fields cannot begin and end with "__"');
    }, t;
}(), ga = /** @class */ function() {
    function t(t, e, n) {
...
/** Parse document data from a set() call. */ function ba$1(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.Bc(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Oa$1("Data must be an object, but it was:", s, r);
    var u, a, c = Ca$1(r, s);
    if (o.merge) u = new Y$1(s.fieldMask), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var d = La$1(e, l[f], n);
            if (!s.contains(d)) throw new S$1(_.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            Va$1(h, d) || h.push(d);
        }
        u = new Y$1(h), a = s.fieldTransforms.filter((function(t) {
            return u.covers(t.field);
        }));
    } else u = null, a = s.fieldTransforms;
    return new pa$1(new It(c), u, a);
}

var Ia$1 = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
...
/** Parse update data from an update() call. */ function Da$1(t, e, n, r) {
    var i = t.Bc(1 /* Update */ , e, n);
    Oa$1("Data must be an object, but it was:", i, r);
    var o = [], s = It.empty();
    K$1(r, (function(t, r) {
        var a = Ma$1(e, t, n);
...
/** Parse update data from a list of field/value arguments. */ function Aa$1(t, e, n, r, i, o) {
    var s = t.Bc(1 /* Update */ , e, n), a = [ La$1(e, r, n) ], c = [ i ];
    if (o.length % 2 != 0) throw new S$1(_.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var h = 0; h < o.length; h += 2) a.push(La$1(e, o[h])), c.push(o[h + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var f = [], l = It.empty(), d = a.length - 1; d >= 0; --d) if (!Va$1(f, a[d])) {
        var p = a[d], y = c[d];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        y = getModularInstance(y);
        var v = s.kc(p);
        if (y instanceof Ia$1) 
        // Add it to the field mask, but don't add anything to updateData.
        f.push(p); else {
            var m = xa(y, v);
 ...
 */ function xa(t, e) {
    ...
    // from firestore-exp.
    t = getModularInstance(t))) return Oa$1("Unsupported field value:", e, t), Ca$1(t, e);
    if (t instanceof fa$1) 
    ...
    return function(t, e) {
        ...
        if (!va$1(e.Dc)) throw e.$c(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if (t instanceof U$1) {
            ...
            n = new U$1(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
                timestampValue: gn(e.R, n)
            };
        }
...
function Ca$1(t, e) {
    ...
    e.path && e.path.length > 0 && e.fieldMask.push(e.path) : K$1(t, (function(t, r) {
        var i = xa(r, e.Nc(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function Ra$1(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof U$1 || t instanceof la || t instanceof ha$1 || t instanceof Wu || t instanceof fa$1);
}
 ...
 */ function La$1(t, e, n) {
    ...
    // FieldPath.
    (e = getModularInstance(e)) instanceof ca$1) return e._internalPath;
 ...
 * evaluated.
 */ function Ma$1(t, e, n) {
    if (e.search(Pa$1) >= 0) throw Fa$1("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return (new (ca$1.bind.apply(ca$1, __spreadArray([ void 0 ], e.split(".")))))._internalPath;
    } catch (r) {
 ...
 */ var qa$1 = /** @class */ function() {
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new Ua$1(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(Ba$1("DocumentSnapshot.get", t));
            if (null !== e) return this._userDataWriter.convertValue(e);
        }
    }, t;
}(), Ua$1 = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    /**
 ...
 */
function Ba$1(t, e) {
    return "string" == typeof e ? Ma$1(t, e) : e instanceof ca$1 ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var ja$1 = /** @class */ function() {
    ...
    e.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new Ga$1(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    e.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(Ba$1("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, e;
}(qa$1), Ga$1 = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    /**
...
}(Ka$1), Qa$1 = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new ja$1(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new Ga$1(n._firestore, n._userDataWriter, r.key, r, new ja$1(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
    ...
    t.prototype.docChanges = function(t) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new S$1(_.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    var r = new Ga$1(t._firestore, t._userDataWriter, e.doc.key, e.doc, new ja$1(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new Ga$1(t._firestore, t._userDataWriter, e.doc.key, e.doc, new ja$1(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 */ function Wa$1(t, e) {
    return t instanceof Ka$1 && e instanceof Ka$1 ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof Qa$1 && e instanceof Qa$1 && t._firestore === e._firestore && Zu(t.query, e.query) && t.metadata.isEqual(e.metadata) && t._snapshot.isEqual(e._snapshot);
}
 ...
 * limitations under the License.
 */ function Ha$1(t) {
    if (Ht(t) && 0 === t.explicitOrderBy.length) throw new S$1(_.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var $a$1 = /** @class */ function(t) {
    ...
    return __extends$1(e, t), e.prototype._apply = function(t) {
        var e = wa$1(t.firestore), n = function(t, e, n, r, i, o, s) {
            var u;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new S$1(_.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || ic$1(s, o), 
            u = ka$1(n, "where", s, 
            ...
            return function(t, e) {
                if (e.g()) {
                    var n = Xt(t);
                    if (null !== n && !n.isEqual(e.field)) throw new S$1(_.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = Yt(t);
 ...
 */
                ...
                throw i === e.op ? new S$1(_.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new S$1(_.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, l), l;
    ...
    return __extends$1(e, t), e.prototype._apply = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new S$1(_.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new S$1(_.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new Ut(e, n);
            return function(t, e) {
                if (null === Yt(t)) {
...
function nc$1(t, e, n, r) {
    if (n[0] = getModularInstance(n[0]), n[0] instanceof qa$1) return function(t, e, n, r, i) {
        if (!r) throw new S$1(_.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        for (var o = [], s = 0, u = Jt(t); s < u.length; s++) {
            ...
            if (a.field.isKeyField()) o.push(yt(e, r.key)); else {
                ...
                if (et(c)) throw new S$1(_.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var h = a.field.canonicalString();
                    throw new S$1(_.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    var i = wa$1(t.firestore);
    return function(t, e, n, r, i, o) {
        // Use explicit order by's because it has to match the query the user made
        var s = t.explicitOrderBy;
        if (i.length > s.length) throw new S$1(_.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var u = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (s[a].field.isKeyField()) {
                if ("string" != typeof c) throw new S$1(_.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!$t(t) && -1 !== c.indexOf("/")) throw new S$1(_.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(z$1.fromString(c));
                if (!ut.isDocumentKey(h)) throw new S$1(_.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var f = new ut(h);
                u.push(yt(e, f));
            } else {
                var l = ka$1(n, r, c);
...
function rc$1(t, e, n) {
    if ("string" == typeof (n = getModularInstance(n))) {
        if ("" === n) throw new S$1(_.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!$t(e) && -1 !== n.indexOf("/")) throw new S$1(_.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(z$1.fromString(n));
        if (!ut.isDocumentKey(r)) throw new S$1(_.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return yt(t, new ut(r));
    }
    if (n instanceof Wu) return yt(t, n._key);
    throw new S$1(_.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ju(n) + ".");
}
 ...
 * array requirements.
 */ function ic$1(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new S$1(_.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new S$1(_.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function oc$1(t, e, n) {
    if (!n.isEqual(e)) throw new S$1(_.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
 ...
 */ var sc$1 = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        var n = this, r = {};
        return K$1(t.fields || {}, (function(t, i) {
            r[t] = n.convertValue(i, e);
        })), r;
    }, t.prototype.convertGeoPoint = function(t) {
        return new la(Z$1(t.latitude), Z$1(t.longitude));
...
var ac$1 = /** @class */ function(t) {
...
}(sc$1), cc$1 = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = wa$1(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = hc$1(t, this._firestore), i = uc$1(r.converter, e, n), o = ba$1(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, _e.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, s = hc$1(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = getModularInstance(e)) || e instanceof ca$1 ? Aa$1(this._dataReader, "WriteBatch.update", s._key, e, n, r) : Da$1(this._dataReader, "WriteBatch.update", s._key, e), 
    ...
    t.prototype.commit = function() {
        ...
        if (this._committed) throw new S$1(_.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();
 ...
 * called.
 */ function hc$1(t, e) {
    if ((t = getModularInstance(t)).firestore !== e) throw new S$1(_.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function lc$1(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = Ku(t, Wu);
    var o = Ku(t.firestore, ia), s = wa$1(o);
    return pc$1(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = getModularInstance(e)) || e instanceof ca$1 ? Aa$1(s, "updateDoc", t._key, e, n, r) : Da$1(s, "updateDoc", t._key, e)).toMutation(t._key, _e.exists(!0)) ]);
}
 ...
 */ function dc$1(t) {
    ...
    "object" != typeof i[a] || ea$1(i[a]) || (s = i[a], a++);
    var c, h, f, l = {
 ...
 */ function yc$1(t, e, n) {
    var r = n.docs.get(e._key), i = new fc$1(t);
    return new Ka$1(t, i, e._key, r, new ja$1(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var vc$1 = /** @class */ function(t) {
     ...
     */    return __extends$1(e, t), e.prototype.get = function(e) {
        var n = this, r = hc$1(e, this._firestore), i = new fc$1(this._firestore);
        return t.prototype.get.call(this, e).then((function(t) {
            return new Ka$1(n._firestore, i, r._key, t._document, new ja$1(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = wa$1(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = hc$1(t, this._firestore), r = new ac$1(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return R$1();
            var i = t[0];
            if (i.isFoundDocument()) return new qa$1(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new qa$1(e._firestore, r, n._key, null, n.converter);
            throw R$1();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = hc$1(t, this._firestore), i = uc$1(r.converter, e, n), o = ba$1(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = getModularInstance(e)) || e instanceof ca$1 ? Aa$1(this._dataReader, "Transaction.update", s._key, e, n, r) : Da$1(this._dataReader, "Transaction.update", s._key, e), 
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function mc$1() {
    if ("undefined" == typeof Uint8Array) throw new S$1(_.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function gc$1() {
    if ("undefined" == typeof atob) throw new S$1(_.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}

/** Immutable class holding a blob (binary data) */ var wc$1 = /** @class */ function() {
    function t(t) {
        this._delegate = t;
    }
    return t.fromBase64String = function(e) {
        return gc$1(), new t(ha$1.fromBase64String(e));
    }, t.fromUint8Array = function(e) {
        return mc$1(), new t(ha$1.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return gc$1(), this._delegate.toBase64();
    }, t.prototype.toUint8Array = function() {
        return mc$1(), this._delegate.toUint8Array();
    }, t.prototype.isEqual = function(t) {
    ...
    return t.prototype.enableIndexedDbPersistence = function(t, e) {
        return function(t, e) {
            aa$1(t = Ku(t, ia));
            var n = oa$1(t), r = t._freezeSettings(), i = new hu;
            return ua$1(n, i, new au(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
        }(t._delegate, {
            forceOwnership: e
        });
        ...
        return function(t) {
            aa$1(t = Ku(t, ia));
            var e = oa$1(t), n = t._freezeSettings(), r = new hu;
            return ua$1(e, r, new cu(r, n.cacheSizeBytes));
        }(t._delegate);
    }, t.prototype.clearIndexedDbPersistence = function(t) {
        return function(t) {
            var e = this;
            if (t._initialized && !t._terminated) throw new S$1(_.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
            var n = new mr;
 ...
 */;
    ...
    return Object.defineProperty(t.prototype, "_databaseId", {
        ...
        void 0 === n && (n = {}), function(t, e, n, r) {
            ...
            if ("firestore.googleapis.com" !== i.host && i.host !== e && x$1("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
            t._setSettings(Object.assign(Object.assign({}, i), {
                ...
                if (!s) throw new S$1(_.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
        ...
        /** Disables the network connection. Pending operations will not complete. */ (oa$1(Ku(this._delegate, ia)));
 ...
 */;
            }(oa$1(t = Ku(t, ia)), ea$1(e) ? e : {
                next: e
            });
        }(this._delegate, t);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.Xc) throw new S$1(_.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Xc;
        },
        enumerable: !1,
        configurable: !0
        ...
        try {
            return new Mc$1(this, Xu(this._delegate, t));
        } catch (t) {
            throw Ac$1(t, "collection()", "Firestore.collection()");
        }
    }, t.prototype.doc = function(t) {
        try {
            return new Dc$1(this, $u(this._delegate, t));
        } catch (t) {
            throw Ac$1(t, "doc()", "Firestore.doc()");
        }
    }, t.prototype.collectionGroup = function(t) {
        try {
            return new Oc$1(this, function(t, e) {
                if (t = Ku(t, zu), Fu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new S$1(_.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new Hu(t, 
                /* converter= */ null, 
                /**
 ...
 */
                function(t) {
                    return new Gt(z$1.emptyPath(), t);
                }(e));
            }(this._delegate, t));
        } catch (t) {
            throw Ac$1(t, "collectionGroup()", "Firestore.collectionGroup()");
        }
        ...
        var t = this;
        return oa$1(this._delegate), new Sc$1(new cc$1(this._delegate, (function(e) {
            return pc$1(t._delegate, e);
        })));
    }, t.prototype.loadBundle = function(t) {
        throw new S$1(_.FAILED_PRECONDITION, '"loadBundle()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, t.prototype.namedQuery = function(t) {
        throw new S$1(_.FAILED_PRECONDITION, '"namedQuery()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, t;
    ...
    return __extends$1(e, t), e.prototype.convertBytes = function(t) {
        return new wc$1(new ha$1(t));
    }, e.prototype.convertReference = function(t) {
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Dc$1.Zc(e, this.firestore, /* converter= */ null);
    }, e;
}(sc$1);
 ...
 */ var _c = /** @class */ function() {
    function t(t, e) {
        this._firestore = t, this._delegate = e, this._userDataWriter = new Tc$1(t);
    }
    return t.prototype.get = function(t) {
        var e = this, n = Fc$1(t);
        return this._delegate.get(n).then((function(t) {
            return new Cc$1(e._firestore, new Ka$1(e._firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, n.converter));
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Fc$1(t);
    ...
    return t.prototype.fromFirestore = function(t, e) {
        var n = new Ga$1(this._firestore._delegate, this._userDataWriter, t._key, t._document, t.metadata, 
        /* converter= */ null);
        return this._delegate.fromFirestore(new Rc$1(this._firestore, n), null != e ? e : {});
    ...
    t.tu = function(e, n) {
        ...
        var o = i.get(n);
        return o || (o = new t(e, new Tc$1(e), n), i.set(n, o)), o;
    }, t;
}();
...
var Dc$1 = /** @class */ function() {
    function t(t, e) {
        this.firestore = t, this._delegate = e, this._userDataWriter = new Tc$1(t);
    }
    return t.nu = function(e, n, r) {
        if (e.length % 2 != 0) throw new S$1(_.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + e.canonicalString() + " has " + e.length);
        ...
        get: function() {
            return new Mc$1(this.firestore, this._delegate.parent);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "path", {
        ...
        try {
            return new Mc$1(this.firestore, Xu(this._delegate, t));
        } catch (t) {
            throw Ac$1(t, "collection()", "DocumentReference.collection()");
        }
    }, t.prototype.isEqual = function(t) {
        return (t = getModularInstance(t)) instanceof Wu && Ju(this._delegate, t);
    }, t.prototype.set = function(t, e) {
        e = Vu("DocumentReference.set", e);
        try {
            return function(t, e, n) {
                t = Ku(t, Wu);
                var r = Ku(t.firestore, ia), i = uc$1(t.converter, e, n);
                return pc$1(r, [ ba$1(wa$1(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, _e.none()) ]);
            }(this._delegate, t, e);
        } catch (t) {
            throw Ac$1(t, "setDoc()", "DocumentReference.set()");
        }
    }, t.prototype.update = function(t, e) {
        for (var n = [], r = 2; r < arguments.length; r++) n[r - 2] = arguments[r];
        try {
            return 1 === arguments.length ? lc$1(this._delegate, t) : lc$1.apply(void 0, __spreadArray([ this._delegate, t, e ], n));
        } catch (t) {
            throw Ac$1(t, "updateDoc()", "DocumentReference.update()");
        }
    }, t.prototype.delete = function() {
        return pc$1(Ku((t = this._delegate).firestore, ia), [ new qe(t._key, _e.none()) ]);
        var t;
        /**
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        var r = kc$1(e), i = xc(e, (function(e) {
            return new Cc$1(t.firestore, new Ka$1(t.firestore._delegate, t._userDataWriter, e._key, e._document, e.metadata, t._delegate.converter));
        }));
        return dc$1(this._delegate, r, i);
    }, t.prototype.get = function(t) {
        var e = this;
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            t = Ku(t, Wu);
            var e = Ku(t.firestore, ia), n = oa$1(e), r = new fc$1(e);
            return function(t, e) {
                var n = this, r = new mr;
                return t.asyncQueue.enqueueAndForget((function() {
                    return __awaiter(n, void 0, void 0, (function() {
                                    ...
                                    return __awaiter(this, void 0, void 0, (function() {
                                        ...
                                        return __generator(this, (function(o) {
                                            switch (o.label) {
                                              ...
                                              case 1:
                                                return (i = o.sent()).isFoundDocument() ? n.resolve(i) : i.isNoDocument() ? n.resolve(null) : n.reject(new S$1(_.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                [ 3 /*break*/ , 3 ];
                ...
                return new Ka$1(e, r, t._key, n, new ja$1(null !== n && n.hasLocalMutations, 
                /* fromCache= */ !0), t.converter);
            }));
        }(this._delegate) : "server" === (null == t ? void 0 : t.source) ? function(t) {
            t = Ku(t, Wu);
            var e = Ku(t.firestore, ia);
            return Nu(oa$1(e), t._key, {
                source: "server"
            }).then((function(n) {
                return yc$1(e, t, n);
            }));
            ...
            t = Ku(t, Wu);
            var e = Ku(t.firestore, ia);
            return Nu(oa$1(e), t._key).then((function(n) {
                return yc$1(e, t, n);
            }));
        }(this._delegate)).then((function(t) {
            return new Cc$1(e.firestore, new Ka$1(e.firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, e._delegate.converter));
        }));
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(Nc$1.tu(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
function kc$1(t) {
    for (var e = 0, n = t; e < n.length; e++) {
        var r = n[e];
        if ("object" == typeof r && !ea$1(r)) return r;
    }
    return {};
}
 ...
 */ function xc(t, e) {
    ...
    return {
        ...
        error: null === (n = (i = ea$1(t[0]) ? t[0] : ea$1(t[1]) ? t[1] : "function" == typeof t[0] ? {
            next: t[0],
            error: t[1],
            complete: t[2]
        } : {
...
var Cc$1 = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "ref", {
        get: function() {
            return new Dc$1(this._firestore, this._delegate.ref);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "id", {
        ...
        return Wa$1(this._delegate, t._delegate);
    }, t;
}(), Rc$1 = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    ...
    return t.prototype.where = function(e, n, r) {
        try {
            ...
            return new t(this.firestore, Xa$1(this._delegate, function(t, e, n) {
                var r = e, i = Ba$1("where", t);
                return new $a$1(i, r, n);
            }(e, n, r)));
        } catch (e) {
            throw Ac$1(e, /(orderBy|where)\(\)/, "Query.$1()");
        }
        ...
        try {
            ...
            // FieldPath Compat type as input, but is not typed as such in order to
            // not expose this via our public typings file.
            return new t(this.firestore, Xa$1(this._delegate, function(t, e) {
                void 0 === e && (e = "asc");
                var n = e, r = Ba$1("orderBy", t);
                return new Ja$1(r, n);
            }(e, n)));
        } catch (e) {
            throw Ac$1(e, /(orderBy|where)\(\)/, "Query.$1()");
        ...
        try {
            return new t(this.firestore, Xa$1(this._delegate, function(t) {
                return Gu("limit", t), new Za$1("limit", t, "F" /* First */);
            }(e)));
        } catch (e) {
            throw Ac$1(e, "limit()", "Query.limit()");
        }
    }, t.prototype.limitToLast = function(e) {
        try {
            return new t(this.firestore, Xa$1(this._delegate, function(t) {
                return Gu("limitToLast", t), new Za$1("limitToLast", t, "L" /* Last */);
            }(e)));
        } catch (e) {
            throw Ac$1(e, "limitToLast()", "Query.limitToLast()");
        }
    }, t.prototype.startAt = function() {
        for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        try {
            return new t(this.firestore, Xa$1(this._delegate, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new tc("startAt", t, /*before=*/ !0);
            }.apply(void 0, e)));
        } catch (e) {
            throw Ac$1(e, "startAt()", "Query.startAt()");
        }
        ...
        try {
            ...
            throw Ac$1(e, "startAfter()", "Query.startAfter()");
        }
        ...
        try {
            ...
            throw Ac$1(e, "endBefore()", "Query.endBefore()");
        }
        ...
        try {
            ...
            throw Ac$1(e, "endAt()", "Query.endAt()");
        }
    }, t.prototype.isEqual = function(t) {
     ...
     */
        function(t) {
            ...
            t = Ku(t, Hu);
            var e = Ku(t.firestore, ia), n = oa$1(e), r = new fc$1(e);
            return Ha$1(t._query), Du(n, t._query).then((function(n) {
                return new Qa$1(e, r, t, n);
            }));
        }(this._delegate)).then((function(t) {
            return new Pc$1(e.firestore, new Qa$1(e.firestore._delegate, e._userDataWriter, e._delegate, t._snapshot));
        }));
    }, t.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = kc$1(e), i = xc(e, (function(e) {
            return new Pc$1(t.firestore, new Qa$1(t.firestore._delegate, t._userDataWriter, t._delegate, e._snapshot));
        }));
        return dc$1(this._delegate, r, i);
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(Nc$1.tu(this.firestore, e)) : this._delegate.withConverter(null));
    ...
    return Object.defineProperty(t.prototype, "type", {
        ...
        get: function() {
            return new Rc$1(this._firestore, this._delegate.doc);
        },
        enumerable: !1,
        configurable: !0
    ...
    return Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new Oc$1(this._firestore, this._delegate.query);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "metadata", {
        ...
        get: function() {
            ...
            return this._delegate.docs.map((function(e) {
                return new Rc$1(t._firestore, e);
            }));
        },
        enumerable: !1,
        configurable: !0
        ...
        return this._delegate.docChanges(t).map((function(t) {
            return new Lc$1(e._firestore, t);
        }));
    }, t.prototype.forEach = function(t, e) {
        var n = this;
        this._delegate.forEach((function(r) {
            t.call(e, new Rc$1(n._firestore, r));
        }));
    }, t.prototype.isEqual = function(t) {
        return Wa$1(this._delegate, t._delegate);
    }, t;
}(), Mc$1 = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
    ...
    return __extends$1(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        try {
            return new Dc$1(this.firestore, void 0 === t ? $u(this._delegate) : $u(this._delegate, t));
        } catch (t) {
            throw Ac$1(t, "doc()", "CollectionReference.doc()");
        }
    }, e.prototype.add = function(t) {
        var e = this;
        return function(t, e) {
            var n = Ku(t.firestore, ia), r = $u(t), i = uc$1(t.converter, e);
            return pc$1(n, [ ba$1(wa$1(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, _e.exists(!1)) ]).then((function() {
                return r;
            }));
        ...
        return new e(this.firestore, t ? this._delegate.withConverter(Nc$1.tu(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}(Oc$1);
 ...
 */ var Vc$1 = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        this._delegate = new (ca$1.bind.apply(ca$1, __spreadArray([ void 0 ], t)));
    }
    return t.documentId = function() {
         ...
         * effect is the same.
         */
        return new t(H$1.keyField().canonicalString());
    }, t.prototype.isEqual = function(t) {
        return (t = getModularInstance(t)) instanceof ca$1 && this._delegate._internalPath.isEqual(t._internalPath);
    }, t;
}(), qc$1 = /** @class */ function() {
    function t(t) {
        this._delegate = t;
    ...
    return t.serverTimestamp = function() {
        var e = new Ea$1("serverTimestamp");
        return e._methodName = "FieldValue.serverTimestamp", new t(e);
    }, t.delete = function() {
        var e = new Ia$1("deleteField");
 ...
 */
    return function(t, e) {
        var n = oa$1(t = Ku(t, ia)), r = new na$1;
        return function(t, e, n, r) {
...
function Bc$1(t) {
    ...
    }(oa$1(e = Ku(e, ia)), n).then((function(t) {
        return t ? new Hu(e, null, t.query) : null;
    }))).then((function(t) {
        return t ? new Oc$1(r, t) : null;
    }));
}
 ...
 */
    function(e, r) {
        ...
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, L$2)));
    }(e, (function(e, s) {
        return new Ic$1(e, new ia(e, s), new bc$1);
    })), e.registerVersion("@firebase/firestore", "2.3.0");
}

P$2(firebase$1);

export { Bc$1 as B, Ic$1 as I, Uc$1 as U };
