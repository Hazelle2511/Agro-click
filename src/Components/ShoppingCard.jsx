          ...
          <div className="flex  shadow-md my-10">
            <div className="w-3/4 bg-white px-10 py-10">
              ...
              <div className="flex mt-10 mb-5">
                <h3 className="font-semibold text-gray-600 text-xs uppercase w-2/5">Détails</h3>
              </div>
              ...
              <div id="summary" className="w-3/4 px-8 py-10">
              ...
              <div className="flex justify-around hover:bg-gray-100 -mx-8 px-6 py-5">
            ...
            <div id="summary" className="w-1/4 px-8 py-10">
              <h1 className="font-semibold md:text-2xl sm:text-xs border-b pb-8">Ma commande</h1>
