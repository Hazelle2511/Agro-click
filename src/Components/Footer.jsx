    ...
    <footer className="flex flex-wrap items-center justify-between p-3 m-auto">
        <div className="container mx-auto flex flex-col flex-wrap items-center justify-between">
            <ul className="flex mx-auto text-white text-center">
              <li className="p-2 cursor-pointer hover:underline">Termes & Conditions</li>
              <li className="p-2 cursor-pointer hover:underline">Politique de confidentialité</li>
              <li className="p-2 cursor-pointer hover:underline">Conditions d'utilisations</li>
            </ul>
            <ul className="flex mx-auto text-white text-center">
