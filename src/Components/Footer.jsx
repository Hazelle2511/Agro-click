...
import footer from '../../public/locales/components/footer.json';

//For multilanguage translation
const locale = navigator.language.substr(0, 2)
const lang = Object.keys(footer).includes(locale) ? locale : 'fr' 
//
    ...
    <footer className="flex flex-wrap items-center justify-between p-3 m-auto">
        <div className="container mx-auto flex flex-col flex-wrap items-center justify-between">
            <ul className="flex mx-auto text-white text-center">
              <li className="p-2 cursor-pointer hover:underline">{footer[lang].terms}</li>
              <li className="p-2 cursor-pointer hover:underline">{footer[lang].politique}</li>
              <li className="p-2 cursor-pointer hover:underline">{footer[lang].condition}</li>
            </ul>
            <ul className="flex mx-auto text-white text-center">
