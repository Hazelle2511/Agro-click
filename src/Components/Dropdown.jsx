...
const Dropdown = ({isOpen, toggle}) => {
    ...
    return(
        <div className={isOpen ? "grid grid-rows-4 text-center  items-center h-screen w-screen -mt-16 text-2xl bg-yellow-500  block  sticky top-0 animated z-40  overflow-hidden"  : "hidden"} 
        onClick={toggle}>     
